...
- 필수 상태: `확정 0장 / 초안 31장 / 없음 94장`
- 전체 관리 대상: `225장` (`초안 31장 / 없음 194장`)

### 중요한 현재 상태

최신 브랜치에는 30종 손님, 카드 뽑기, 룰렛과 움직임 계약이 추가됐다. 기존 점장
`make/sell`과 토끼는 실제 Godot 화면에 표시되지만 새 제작 규격의 절반 크기인 구규격이다.
직원 8장, 점장 걷기·수면·촌장 4장, 손님 16장은 새 규격으로 생성했다. 서른한 장 모두
...
| 손님 | 토끼와 새 규격 16종 초안, 없음 13장 | 필드용 30종. 나머지는 도형·이모지 |
...
| 손님 필드 | 30 | 0 | 17 | 13 | 128×128 → 64×64 |
