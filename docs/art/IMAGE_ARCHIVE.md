...
- 전체 관리 대상: `280장` (`확정 0장 / 초안 280장 / 없음 0장`)

### 중요한 현재 상태

최신 브랜치에는 가게 10채, 30종 손님, 카드 뽑기, 룰렛과 움직임 계약이 추가됐다. 기존 점장
`make/sell`과 토끼는 실제 Godot 화면에 표시되지만 새 제작 규격의 절반 크기인 구규격이다.
직원 8장, 점장 걷기·수면·촌장 4장, 손님 29장, 뽑기·룰렛 3장, 손님 카드 1단 30장, 상호작용 3장, 물건 80장과 좌판 10장은 새 규격으로 생성했다. 선택 전용 점장 20장과 성장 카드 2~4단 90장도 모두 들어왔다. 필수 백일흔 장과 선택 백열 장 모두
...
| 손님 카드 | 1단 초안 30장 + 2~4단 초안 90장 | 30종 × 4단 120장이 모두 들어왔고 성 구간별 로더·화면 검수 대기 |
...
### 손님 성장 카드 2단 다섯 번째 5장 초안

<table>
  <tr><td align="center"><img src="./qa/guest-cards-tier2-batch-05.png" width="760" alt="살쾡이 산양 담비 원앙 늑대의 2단 성장 카드 초안"></td></tr>
  <tr><td><strong>Generated · LOG-CARD-011</strong><br>황혼 산길·바위 비탈·단풍 숲·연못·겨울길의 개체와 계절을 유지하고 돌담·계단·물가·장작의 수선만 한 단계 올렸다.</td></tr>
</table>

### 손님 성장 카드 2단 여섯 번째 5장 초안

<table>
  <tr><td align="center"><img src="./qa/guest-cards-tier2-batch-06.png" width="760" alt="백로 표범 사향노루 반달곰 해태의 2단 성장 카드 초안"></td></tr>
  <tr><td><strong>Generated · LOG-CARD-012</strong><br>논·산길·약초밭·눈길·마을 입구를 각자의 계절 안에서 수선하고, 희귀 손님도 마법이나 궁전 장식 없이 유지했다.</td></tr>
</table>

### 손님 성장 카드 2단 30종 전체 초안

<table>
  <tr><td align="center"><img src="./qa/guest-cards-tier2-all-30.png" width="760" alt="손님 성장 카드 2단 30종 전체 초안"></td></tr>
  <tr><td><strong>Generated · 2단 30/30</strong><br>같은 개체와 계절을 잇고, 수선된 길·담·물길·생활소품으로만 ‘외곽 방문객에서 익숙한 단골’로 성장시켰다.</td></tr>
</table>

### 손님 성장 카드 3단 첫 5장 초안

<table>
  <tr><td align="center"><img src="./qa/guest-cards-tier3-batch-01.png" width="760" alt="토끼 까치 다람쥐 오소리 여우의 3단 성장 카드 초안"></td></tr>
  <tr><td><strong>Generated · LOG-CARD-013</strong><br>2단의 개체·자세·계절을 그대로 잇고 열린 문·낮은 좌판·삼베 그늘막·준비된 물건으로 ‘장날의 오래된 벗’ 가정을 시험했다.</td></tr>
</table>

### 손님 성장 카드 3단 두 번째 5장 초안

<table>
  <tr><td align="center"><img src="./qa/guest-cards-tier3-batch-02.png" width="760" alt="사슴 멧돼지 곰 거북 두루미의 3단 성장 카드 초안"></td></tr>
  <tr><td><strong>Generated · LOG-CARD-014</strong><br>단풍길·추수마당·눈길·연못·나루의 기존 기능을 산물·곡식·저장품·쉼터·여행 물품의 장날 쓰임으로 확장했다.</td></tr>
</table>

### 손님 성장 카드 3단 세 번째 5장 초안

<table>
  <tr><td align="center"><img src="./qa/guest-cards-tier3-batch-03.png" width="760" alt="소 호랑이 참새 개구리 두더지의 3단 성장 카드 초안"></td></tr>
  <tr><td><strong>Generated · LOG-CARD-015</strong><br>논머리·산길·곡식마당·물길·텃밭에 몸집과 등급에 맞춘 장날 흔적을 두어 희귀도 양끝에서도 같은 3단 가정을 유지했다.</td></tr>
</table>

### 손님 성장 카드 3단 네 번째 5장 초안

<table>
  <tr><td align="center"><img src="./qa/guest-cards-tier3-batch-04.png" width="760" alt="고슴도치 오리 수달 노루 족제비의 3단 성장 카드 초안"></td></tr>
  <tr><td><strong>Generated · LOG-CARD-016</strong><br>대추 건조마당·연못 산물장·나루 여행장·묘목장·옹기마당으로 각 동물의 생활 장소를 장날 풍경에 연결했다.</td></tr>
</table>

### 손님 성장 카드 3단 다섯 번째 5장 초안

<table>
  <tr><td align="center"><img src="./qa/guest-cards-tier3-batch-05.png" width="760" alt="살쾡이 산양 담비 원앙 늑대의 3단 성장 카드 초안"></td></tr>
  <tr><td><strong>Generated · LOG-CARD-017</strong><br>황혼·산길·단풍·연못·겨울의 고유색을 지키면서 건물 가장자리의 작은 산물장과 저장품장만 더했다.</td></tr>
</table>

### 손님 성장 카드 3단 여섯 번째 5장 초안

<table>
  <tr><td align="center"><img src="./qa/guest-cards-tier3-batch-06.png" width="760" alt="백로 표범 사향노루 반달곰 해태의 3단 성장 카드 초안"></td></tr>
  <tr><td><strong>Generated · LOG-CARD-018</strong><br>논물길·산길·약초길·눈길·마을 입구에서 희귀도가 높은 동물도 장식 없이 생활 장소의 장날 쓰임으로만 성장시켰다.</td></tr>
</table>

### 손님 성장 카드 3단 30종 전체 초안

<table>
  <tr><td align="center"><img src="./qa/guest-cards-tier3-all-30.png" width="760" alt="손님 성장 카드 3단 30종 전체 초안"></td></tr>
  <tr><td><strong>Generated · 3단 30/30</strong><br>같은 개체·자세·계절·2단 장소를 잇고 주변부의 낮은 좌판과 준비된 물건으로만 ‘장날의 오래된 벗’을 시험했다.</td></tr>
</table>

### 손님 성장 카드 4단 첫 5장 초안

<table>
  <tr><td align="center"><img src="./qa/guest-cards-tier4-batch-01.png" width="760" alt="토끼 까치 다람쥐 오소리 여우의 4단 성장 카드 초안"></td></tr>
  <tr><td><strong>Generated · LOG-CARD-019</strong><br>물건과 장식을 더 쌓지 않고 열린 문·이어진 석축·배수로·공동길로 ‘함께 지킨 풍경’ 가정을 시험했다.</td></tr>
</table>

### 손님 성장 카드 4단 두 번째 5장 초안

<table>
  <tr><td align="center"><img src="./qa/guest-cards-tier4-batch-02.png" width="760" alt="사슴 멧돼지 곰 거북 두루미의 4단 성장 카드 초안"></td></tr>
  <tr><td><strong>Generated · LOG-CARD-020</strong><br>가을길·수확마당·눈길·연못·나루의 길과 물길을 완전히 연결해 계절이 달라도 ‘함께 지킨 풍경’을 유지했다.</td></tr>
</table>

### 손님 성장 카드 4단 세 번째 5장 초안

<table>
  <tr><td align="center"><img src="./qa/guest-cards-tier4-batch-03.png" width="760" alt="소 호랑이 참새 개구리 두더지의 4단 성장 카드 초안"></td></tr>
  <tr><td><strong>Generated · LOG-CARD-021</strong><br>논·산길·곡식마당·수로·텃밭을 연결된 기반시설로 확장해 크고 작은 동물 모두 같은 4단 가정을 유지했다.</td></tr>
</table>

### 손님 성장 카드 4단 네 번째 5장 초안

<table>
  <tr><td align="center"><img src="./qa/guest-cards-tier4-batch-04.png" width="760" alt="고슴도치 오리 수달 노루 족제비의 4단 성장 카드 초안"></td></tr>
  <tr><td><strong>Generated · LOG-CARD-022</strong><br>과수원·습지·나루·묘목장·옹기마당의 열린 문과 길·배수·관개를 연결해 작은 동물의 4단 생활권을 확장했다.</td></tr>
</table>

### 손님 성장 카드 4단 다섯 번째 5장 초안

<table>
  <tr><td align="center"><img src="./qa/guest-cards-tier4-batch-05.png" width="760" alt="살쾡이 산양 담비 원앙 늑대의 4단 성장 카드 초안"></td></tr>
  <tr><td><strong>Generated · LOG-CARD-023</strong><br>황혼·산길·단풍·연못·겨울의 명암을 유지하고 고정 창호·치워진 길·온전한 담과 수로로만 4단 회복을 표현했다.</td></tr>
</table>

### 손님 성장 카드 4단 여섯 번째 5장 초안

<table>
  <tr><td align="center"><img src="./qa/guest-cards-tier4-batch-06.png" width="760" alt="백로 표범 사향노루 반달곰 해태의 4단 성장 카드 초안"></td></tr>
  <tr><td><strong>Generated · LOG-CARD-024</strong><br>논수로·산길·약초밭·눈길·마을 입구를 유지하고 이어진 길·담·물길·열린 문으로 4단 30종을 마무리했다.</td></tr>
</table>

### 손님 성장 카드 4단 30종 전체 초안

<table>
  <tr><td align="center"><img src="./qa/guest-cards-tier4-all-30.png" width="760" alt="손님 성장 카드 4단 30종 전체 초안"></td></tr>
  <tr><td><strong>Generated · LOG-CARD-019~024</strong><br>좌판과 상품을 더 쌓지 않고 공동길·석축·배수·수로·열린 문으로 최종 회복을 통일했다. 사용자 승인 전까지 30장 모두 초안이다.</td></tr>
</table>
...
| **필수 합계** | **170** | **0** | **170** | **0** | |
| 손님 성장 카드 (선택) | 90 | 0 | 90 | 0 | 512×768 |
| 가게별 점장 (선택) | 20 | 0 | 20 | 0 | 144×144 → 72×72 |
| **전체 관리 대상** | **280** | **0** | **280** | **0** | |

제작 우선순위는 최신 주문서대로 `손님 필드 30 → 카드 1단 30 → 점장 → 직원 → 물건 80 → 좌판·나쁜 놈`이다.
손님 필드 30종, 손님 카드 1단 30종, 점장, 직원, 물건 80종, 좌판 10종, 상호작용 3종과 룰렛 UI는 모두 초안이다. 필수 170장과 선택 전용 점장 20장, 성장 카드 2단·3단·4단 각 30장을 모두 채웠다. 전체 280장의 다음 단계는 실제 Godot 화면 연결·크기·레이어 검수와 사용자 승인이다.
...
<table>
  <tr><td align="center"><img src="./generated/COUNTERS-RUNTIME-PREVIEW-V0.4.png" width="484" alt="실제 게임 크기의 대장간 필방 지물포 옹기점 약재상 계산대 비교"></td></tr>
  <tr><td><strong>Generated · 계산대 5종</strong><br>모두 168×144 RGBA, 실제 표시 84×72. 대장간은 철 보강띠, 필방은 한지 상판과 서랍, 지물포는 한지 미닫이, 옹기점은 황토판과 벽돌띠, 약재상은 약장 서랍 3×2로 구분하며 판매면은 오른쪽 아래를 향한다.</td></tr>
</table>
