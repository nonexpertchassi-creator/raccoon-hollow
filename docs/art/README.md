...
- 현재 그림 현황: 필수 170장 중 초안 170장, 확정 0장, 없음 0장
- 선택 그림 현황: 전용 점장 초안 20장 · 성장 카드 2단 30장 + 3단 30장 + 4단 30장 초안, 없음 0장
- 다음 목표: 실제 Godot 화면에서 280장 연결·크기·레이어를 검수하고 사용자 승인 대상을 고른다
