...
**4. 마당의 담(울타리 벽)은 그리지 말 것.** 담은 코드가 그린다 — 초가(짚) →
...
### 직원 너구리 — `godot/art/staff/` · 144×144 · **6장 남음**
...
- [ ] `whitehood-work.png` — 흰 두건 · 흰 무명 두건 — 일하는 중
- [ ] `whitehood-sleep.png` — 흰 두건 · 흰 무명 두건 — 조는 중 — 만들 데가 없다
- [ ] `grayhood-work.png` — 회색 두건 · 잿빛 두건 — 일하는 중
- [ ] `grayhood-sleep.png` — 회색 두건 · 잿빛 두건 — 조는 중 — 만들 데가 없다
- [ ] `blackhood-work.png` — 검정 두건 · 검정 두건 — 제일 높다 — 일하는 중
- [ ] `blackhood-sleep.png` — 검정 두건 · 검정 두건 — 제일 높다 — 조는 중 — 만들 데가 없다
...
### 손님 카드 2~4단 (6~20성) (선택) — `godot/art/cards/` · 512×768 · **5장 남음**
...
### 가게별 점장 (선택) — `godot/art/clerks/` · 144×144 · **70장 남음**
...
- [ ] `smith-make-1.png` — 대장간 — 만드는 중 · 2등급 승급판
- [ ] `smith-make-2.png` — 대장간 — 만드는 중 · 3등급 승급판
- [ ] `smith-sell-1.png` — 대장간 — 파는 중 · 2등급 승급판
- [ ] `smith-sell-2.png` — 대장간 — 파는 중 · 3등급 승급판
- [ ] `brush-make-1.png` — 필방 — 만드는 중 · 2등급 승급판
- [ ] `brush-make-2.png` — 필방 — 만드는 중 · 3등급 승급판
- [ ] `brush-sell-1.png` — 필방 — 파는 중 · 2등급 승급판
- [ ] `brush-sell-2.png` — 필방 — 파는 중 · 3등급 승급판
- [ ] `paper-make-1.png` — 지물포 — 만드는 중 · 2등급 승급판
- [ ] `paper-make-2.png` — 지물포 — 만드는 중 · 3등급 승급판
- [ ] `paper-sell-1.png` — 지물포 — 파는 중 · 2등급 승급판
- [ ] `paper-sell-2.png` — 지물포 — 파는 중 · 3등급 승급판
- [ ] `pot-make-1.png` — 옹기점 — 만드는 중 · 2등급 승급판
- [ ] `pot-make-2.png` — 옹기점 — 만드는 중 · 3등급 승급판
- [ ] `pot-sell-1.png` — 옹기점 — 파는 중 · 2등급 승급판
- [ ] `pot-sell-2.png` — 옹기점 — 파는 중 · 3등급 승급판
- [ ] `herb-make-1.png` — 약재상 — 만드는 중 · 2등급 승급판
- [ ] `herb-make-2.png` — 약재상 — 만드는 중 · 3등급 승급판
- [ ] `herb-sell-1.png` — 약재상 — 파는 중 · 2등급 승급판
- [ ] `herb-sell-2.png` — 약재상 — 파는 중 · 3등급 승급판
- [ ] `soup-make-1.png` — 국밥집 — 만드는 중 · 2등급 승급판
- [ ] `soup-make-2.png` — 국밥집 — 만드는 중 · 3등급 승급판
- [ ] `soup-sell-1.png` — 국밥집 — 파는 중 · 2등급 승급판
- [ ] `soup-sell-2.png` — 국밥집 — 파는 중 · 3등급 승급판
- [ ] `gaekju-make-1.png` — 객주 — 만드는 중 · 2등급 승급판
- [ ] `gaekju-make-2.png` — 객주 — 만드는 중 · 3등급 승급판
- [ ] `gaekju-sell-1.png` — 객주 — 파는 중 · 2등급 승급판
- [ ] `gaekju-sell-2.png` — 객주 — 파는 중 · 3등급 승급판
- [ ] `skewer-make-1.png` — 꼬치집 — 만드는 중 · 2등급 승급판
- [ ] `skewer-make-2.png` — 꼬치집 — 만드는 중 · 3등급 승급판
- [ ] `skewer-sell-1.png` — 꼬치집 — 파는 중 · 2등급 승급판
- [ ] `skewer-sell-2.png` — 꼬치집 — 파는 중 · 3등급 승급판
- [ ] `ricecake-make-1.png` — 떡집 — 만드는 중 · 2등급 승급판
- [ ] `ricecake-make-2.png` — 떡집 — 만드는 중 · 3등급 승급판
- [ ] `ricecake-sell-1.png` — 떡집 — 파는 중 · 2등급 승급판
- [ ] `ricecake-sell-2.png` — 떡집 — 파는 중 · 3등급 승급판
- [ ] `butcher-make-1.png` — 푸줏간 — 만드는 중 · 2등급 승급판
- [ ] `butcher-make-2.png` — 푸줏간 — 만드는 중 · 3등급 승급판
- [ ] `butcher-sell-1.png` — 푸줏간 — 파는 중 · 2등급 승급판
- [ ] `butcher-sell-2.png` — 푸줏간 — 파는 중 · 3등급 승급판
- [ ] `fish-make.png` — 어물전 — 만드는 중
- [ ] `fish-make-1.png` — 어물전 — 만드는 중 · 2등급 승급판
- [ ] `fish-make-2.png` — 어물전 — 만드는 중 · 3등급 승급판
- [ ] `fish-sell.png` — 어물전 — 파는 중
- [ ] `fish-sell-1.png` — 어물전 — 파는 중 · 2등급 승급판
- [ ] `fish-sell-2.png` — 어물전 — 파는 중 · 3등급 승급판
- [ ] `cloth-make.png` — 포목전 — 만드는 중
- [ ] `cloth-make-1.png` — 포목전 — 만드는 중 · 2등급 승급판
- [ ] `cloth-make-2.png` — 포목전 — 만드는 중 · 3등급 승급판
- [ ] `cloth-sell.png` — 포목전 — 파는 중
- [ ] `cloth-sell-1.png` — 포목전 — 파는 중 · 2등급 승급판
- [ ] `cloth-sell-2.png` — 포목전 — 파는 중 · 3등급 승급판
- [ ] `hat-make.png` — 갓방 — 만드는 중
- [ ] `hat-make-1.png` — 갓방 — 만드는 중 · 2등급 승급판
- [ ] `hat-make-2.png` — 갓방 — 만드는 중 · 3등급 승급판
- [ ] `hat-sell.png` — 갓방 — 파는 중
- [ ] `hat-sell-1.png` — 갓방 — 파는 중 · 2등급 승급판
- [ ] `hat-sell-2.png` — 갓방 — 파는 중 · 3등급 승급판
- [ ] `brass-make.png` — 유기전 — 만드는 중
- [ ] `brass-make-1.png` — 유기전 — 만드는 중 · 2등급 승급판
- [ ] `brass-make-2.png` — 유기전 — 만드는 중 · 3등급 승급판
- [ ] `brass-sell.png` — 유기전 — 파는 중
- [ ] `brass-sell-1.png` — 유기전 — 파는 중 · 2등급 승급판
- [ ] `brass-sell-2.png` — 유기전 — 파는 중 · 3등급 승급판
- [ ] `lacquer-make.png` — 나전방 — 만드는 중
- [ ] `lacquer-make-1.png` — 나전방 — 만드는 중 · 2등급 승급판
- [ ] `lacquer-make-2.png` — 나전방 — 만드는 중 · 3등급 승급판
- [ ] `lacquer-sell.png` — 나전방 — 파는 중
- [ ] `lacquer-sell-1.png` — 나전방 — 파는 중 · 2등급 승급판
- [ ] `lacquer-sell-2.png` — 나전방 — 파는 중 · 3등급 승급판
