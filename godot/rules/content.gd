...
const GUESTS := [
	...
	},
	{
		...
		"wild": 0.8,
		"at": 69000000000.0,
		"desc": "145초마다 복을 지고 온다 — 최대 16개, 값은 6배",
		"look": "조선 자수의 복(福) 문양 그대로, 오복을 지고 온다"
	},
	{
		"id": "ox",
		"name": "소",
		...
		"wild": 0.9,
		"at": 160000000000.0,
		"desc": "260초마다 짐수레를 끌고 느릿느릿, 최대 26개에 값은 5배",
	...
	},
	{
		...
		"wild": 0.3,
		"at": 999000000000000.0,
		"desc": "뒤뚱뒤뚱 4초마다, 새끼들을 줄줄이 달고 와서 최대 3개",
		"look": "노란 부리에 뒤뚱거리는 걸음, 새끼 오리들이 줄지어 따른다"
	},
	{
		"id": "badger",
		"name": "오소리",
	...
	},
	{
		...
		"wild": 0.5,
		"at": 999000000000000.0,
		"desc": "60초마다 짝을 지어 와서 최대 10개, 값은 3배",
