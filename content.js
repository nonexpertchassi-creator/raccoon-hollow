 ...
 * 값은 재서 정했다(4시간 봇, 옛 곡선 2.36B 기준): 3이면 8.69B로 과속,
 * 2면 옛 곡선과 비슷하게 붙는다. 초반(물건 1·손 1)은 옛날보다 2배 빨라
 * 시작이 경쾌하고, 물건이 늘면 손을 채워야 따라잡는다 —
 * 직원을 뽑는 것이 처음으로 진짜 보상이 된다. */
export const CRAFT = { handSpeed: 2 };
...
export const STAFF = {
  ...
  max: 4,
  /* n번째 직원 값: 첫째는 첫 승급값의 6%, 둘째부터는 둘째 승급값에 곱한다.
   * 재보고 고칠 자리다. */
