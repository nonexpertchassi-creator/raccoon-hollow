...
export const STAFF = {
  ...
  /* n번째 직원 값. 첫째는 첫 승급값 기준, 둘째부터는 둘째 승급값 기준.
   *
   * 첫째가 승급값의 3배였다 — 승급하고도 한참 뒤에나 살 수 있었다.
   * 이제 고용이 승급을 안 기다리므로, 첫째는 **승급값의 12%**로 내려
   * 초반에 '물건이 모자란다' 싶을 때 바로 손이 가게 했다.
   * 셋째·넷째는 여전히 콘텐츠가 다 열린 뒤의 목표다. */
  costMul: [0.12, 0.5, 3, 9],
};
