...
export const STAFF = {
  ...
  max: 1,
  /* 첫 승급값의 6%. 처음엔 12%였는데 폰에서 만져 보니 "너무 비싸다"였다.
   * 직원 한 명은 기다림을 79% → 0.7%로 지우는, 이 게임에서 가장 확실한
   * 한 방이다. 그런 걸 한참 모아야 살 수 있게 두면 그 구간 내내 손님이
   * 물건을 못 받고 돌아간다 — 벌 받는 쪽이 사는 사람이다. */
  costMul: [0.06],
};
...
export const STAFF_RANKS = [
  { id: 'band',      name: '머리띠 알바', hat: '수건 머리띠' },
  { id: 'chorip',    name: '초립 일꾼',   hat: '초립(누런 풀 갓)' },
  { id: 'paeraengi', name: '패랭이 선임', hat: '패랭이(챙 넓은 대나무 갓)' },
  { id: 'baengnip',  name: '백립 매니저', hat: '백립(흰 갓)' },
];
