...
이야기 · 대사 · 세계관. 축은 **"무너진 산골 장터에, 짐승 손님들이 하나씩 돌아온다."**
...
| **인트로** | **4컷** — 글은 코드에 들어 있다 |
| **게시판 쪽지** | **9줄** — 처음 일어나는 일마다 한 줄씩 뜬다 |
| **말하는 이** | 게시판이다. 촌장을 없앴다(걸어 다니는 안내자는 찾아다녀야 했다) |

### 아직 안 정한 것

- **인트로 그림 4장이 없다** — 지금은 글만 뜬다. 이게 지금 제일 큰 구멍이다
- **손님 등장을 뽑기가 아니라 이야기로** — 실루엣으로 나타나고 말을 걸면 열린다(정했으나 안 만듦)
- 엔딩 잔치를 어떻게 보여줄 것인가
- 대사는 전부 초안이다 — 뼈대가 굳은 뒤에 다듬는다

**어디를 보나** — 장부: 이야기 · `STORY.md` · `content.js`의 INTRO·BEATS

---

## UX 기획

화면이 어떻게 이어지나, 무엇이 어떻게 움직이나, 손맛.
...
**어디를 보나** — 장부: 한 판의 흐름 · 마당 배치 · 골목과 방향 · `FLOW.md` · `MOTION.md` · `godot/view/`
